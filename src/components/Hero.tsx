  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          src="https://cdn.poehali.dev/projects/4baf3de1-dd67-4c5a-92bd-46b2ee1428d9/bucket/ff66a6f4-041c-4f26-b6bb-a0cdc0056a5e.jpg"
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center mb-0 font-bold text-stone-50">{"Профессиональная химчистка"}</p>

          <h1
            ref={titleRef}
            className="text-center mb-0 tracking-tight leading-[0.9] lg:text-8xl text-cyan-400 text-base font-normal"
